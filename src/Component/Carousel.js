...
function Carousel() {
  return (
    <div className='z-30 h-full bg-white'>
    <h1>Hello1</h1>
    <h1>Hello1</h1>
    <h1>Hello1</h1>
    <div className='h-3/4  flex '>
        ...
        <div className='SecondHalf w-1/2 h-full bg-pink-400'>
        <div id="carouselExampleCaptions" class="carousel slide relative h-full" data-bs-ride="carousel">
  <div class="carousel-indicators absolute right-0 bottom-0 left-0 flex justify-center p-0 mb-4 h-full">
    <button
      type="button"
